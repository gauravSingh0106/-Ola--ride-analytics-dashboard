...
<img width="1092" height="607" alt="PBIDesktop_NPmgNsDnCm" src="https://github.com/user-attachments/assets/fa4453d9-5268-4ce5-baef-d90b2310d971" />
...
- How much revenue is generated from successful rides?
- What is the overall booking success and cancellation rate?
- Which vehicle types contribute most to booking value and revenue?
...
- Customer cancellations (**18.07%**) were higher than driver cancellations (**9.10%**).
- **₹27.56M** revenue came from successful bookings.
- Customer satisfaction remained strong with an average rating of **4.25/5**.
